...
public class LimiteProposta {
    ...
    Proposta selectedProposta = null;
    ...
    void cadastraProposta(int codigo) {
        //Inicializa Tela
        ...
        //Inicializa Labels
        JLabel lbLogo = new JLabel("DADOS DA PROPOSTA");
        ...
        btSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (tfData.getText().equals("")
                    ...
                    ctrProposta.ctrPrincipal.ctrImovel.addProposta(codigo, ctrProposta.cadastraProposta(
                            tfData.getText(),
    ...
    public void listaProposta(Imovel imovel, String estado) {
        ...
        pLabel.add(new JLabel("LISTA DE PROPOSTAS (IMOVEL: " + imovel.getCodigo() + ")"), BorderLayout.CENTER);
        //ComboBox
        ...
        //Adição dos botões
        JButton bAceita = new JButton("Aceitar Proposta");
        JButton bRejeita = new JButton("Rejeitar Proposta");

        cbEstado.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                frConsultar.dispose();
                listaProposta(imovel, (String) cbEstado.getSelectedItem());
            }
        });
        bAceita.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (selectedProposta != null) {
                    frConsultar.dispose();
                    ctrProposta.ctrPrincipal.ctrImovel.aceitaProposta(imovel.getCodigo(), selectedProposta);
                    listaProposta(imovel, estado);
                } else {
                    JOptionPane.showMessageDialog(null,
        ...
        bRejeita.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (selectedProposta != null) {
                    frConsultar.dispose();
                    ctrProposta.ctrPrincipal.ctrImovel.rejeitarProposta(imovel.getCodigo(), selectedProposta);
                    listaProposta(imovel, estado);
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Selecione pelomenos um item na lista!",
        ...
        pButtons.add(bAceita);
        pButtons.add(bRejeita);
                        ...
                        public void itemStateChanged(ItemEvent e) {
                            ...
                            if (e.getStateChange() == ItemEvent.SELECTED) {
                                ...
                                if(p.getEstado().equals(Util.SUBMEDITA)){
                                    bAceita.setEnabled(true);                                    
                                    bRejeita.setEnabled(true);
                                }else{
                                    bAceita.setEnabled(false);                                    
                                    bRejeita.setEnabled(false);
                                }
                            }
                        }
                    });
